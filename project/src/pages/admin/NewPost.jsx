      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-gray-100 text-gray-900 hover:bg-gray-200 transition-colors flex items-center gap-2"
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#11CD80]/10 flex items-center justify-center">
                  <Sparkles className="w-5 h-5 text-[#11CD80]" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Gerar Artigo com IA</h3>
                  <p className="text-gray-600">Configure a geração do seu artigo</p>
                </div>
              </div>
              <button
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <button
                  ...
                  disabled={generating || !aiConfig.prompt}
                  className="bg-[#11CD80] text-white px-6 py-2 rounded-lg hover:bg-[#0fb46f] transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {generating ? (
                    <>
                      <Loader2 className="w-5 h-5 animate-spin" />
